    ...
    return new Container(
      child: new Row(
        children: <Widget>[
          ...
          new Container(
            child: new IconButton(icon: new Icon(Icons.share), onPressed: (){}, padding: const EdgeInsets.all(0.0), iconSize: 18.0),
          ),
          new Container(
            child: new IconButton(icon: new Icon(Icons.list), onPressed: (){}, padding: const EdgeInsets.all(0.0), iconSize: 18.0),
          ),
        ],
      ),
              ...
              children: <Widget>[
                new Container(
                  child: new FlatButton(
                    ...
                    child: new Container(
                      child: new Text("你认为《三体》中最牛的文明是？", style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0, height: 1.3, color: Colors.white70)),
                ...
                new Container(
                  child: new ListTile(
                    ...
                    trailing: new RaisedButton.icon(onPressed: (){}, icon: new Icon(Icons.add), label: new Text("关注"))
                  ),
                  decoration: new BoxDecoration(
                      color: new Color(0xff222222),
                      border: new BorderDirectional(bottom: new BorderSide(color: Colors.white10))
                ...
                new Container(
                  child: new Text(
                      ...
                      style: new TextStyle(height: 1.4, fontSize: 16.0, color: Colors.white70), textAlign: TextAlign.start
                  ),
                      ...
                      children: <Widget>[
                        new IconButton(
                            ...
                            icon: new Container(
                              child: new Column(
                                children: <Widget>[
                                  new Icon(Icons.favorite, size: 18.0, color: Colors.white30,),
                                  new Text("感谢", style: new TextStyle(fontSize: 10.0, color: Colors.white30),)
                                ],
                              ),
                        ...
                        new IconButton(
                            ...
                            icon: new Container(
                              child: new Column(
                                children: <Widget>[
                                  new Icon(Icons.star, size: 18.0, color: Colors.white30,),
                                  new Text("收藏", style: new TextStyle(fontSize: 10.0, color: Colors.white30),)
                                ],
                              ),
                              margin: const EdgeInsets.only(),
                              height: 30.0,
                        ...
                        new IconButton(
                            ...
                            icon: new Container(
                              child: new Column(
                                children: <Widget>[
                                  new Icon(Icons.mode_comment, size: 18.0, color: Colors.white30,),
                                  new Text("345", style: new TextStyle(fontSize: 10.0, color: Colors.white30),)
                                ],
                              ),
                              margin: const EdgeInsets.only(),
                              height: 30.0,
